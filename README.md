...
| Telemetry | `crsf_detect` | When set to `1`, the bridge parses UART traffic for CRSF frames and, with `-v`, prints once-per-second counts for RC channels, GPS, battery, and other frame types to stdout. |
